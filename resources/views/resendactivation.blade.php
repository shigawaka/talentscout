    ...
    @if (Session::has('message'))
        ...
        @endif
                <div class="col-sm-offset-1 col-sm-10">
                    {!! Form::open(['url'=>'/resendActivation']) !!}
                      <div class="form-group">
                        <!-- {{--{!! Form::input('number','userID',null,['class'=>'form-control','placeholder'=>'ID NUMBER']) !!}--}} -->
                        {!! Form::text('emailaddress',null,['class'=>'form-control','placeholder'=>'Enter your email address']) !!}
                      </div>
                      <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                            {!! Form::button('Resend Activation code',['class'=>'btn btn-success btn-lg btn-block', 'type' => 'submit ']) !!}
                        </div>
                        <div class="col-sm-12">
